...
/** @defgroup STM32L100C_DISCOVERY_LOW_LEVEL_Private_Variables
  * @{
  */ 
GPIO_TypeDef* GPIO_PORT[LEDn] = {LED1_GPIO_PORT,LED2_GPIO_PORT,LED3_GPIO_PORT, LED4_GPIO_PORT,LED5_GPIO_PORT,LED6_GPIO_PORT,B7_GPIO_PORT,B8_GPIO_PORT,B9_GPIO_PORT,B10_GPIO_PORT,B11_GPIO_PORT,B12_GPIO_PORT};
const uint16_t GPIO_PIN[LEDn] = {LED1_PIN,LED2_PIN,LED3_PIN,LED4_PIN,LED5_PIN,LED6_PIN,B7_PIN,B8_PIN,B9_PIN,B10_PIN,B11_PIN,B12_PIN};
const uint32_t GPIO_CLK[LEDn] = {LED1_GPIO_CLK,LED2_GPIO_CLK,LED3_GPIO_CLK,LED4_GPIO_CLK, LED5_GPIO_CLK,LED6_GPIO_CLK,B7_GPIO_CLK,B8_GPIO_CLK,B9_GPIO_CLK,B10_GPIO_CLK,B11_GPIO_CLK,B12_GPIO_CLK};
